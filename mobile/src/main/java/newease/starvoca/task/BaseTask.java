...
import newease.starvoca.R;
import newease.starvoca.util.Util;
import newease.starvoca.util.ViewUtil;
                    ...
                    if (activity != null) {
                        activity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                snackbar.setActionTextColor(activity.getResources().getColor(R.color.error_color))
